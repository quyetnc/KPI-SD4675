  ...
  input = () => (
    <TextInput
      ...
      style={[
        ...
        this.props.disabled && {color: colors.gray},
      ]}
  ...
  render() {
    ...
    return (
      <TouchableOpacity
        ...
        {...props}
        onPress={() => {
          this.props.isPicker || this.props.isDatePickers
            ? null
        ...
        style={[
          ...
          {
            borderWidth:
              this.props.isDatePickers || this.props.isTimePickers ? 0 : 1,
          },
        ]}>
        {/* //////label floating///// */}
        <Animated.Text
          ...
          <>
            ...
            <TouchableOpacity
              ...
              <Image
                ...
                source={
                  !this.state.hidePassword ? Images.ic_eye : Images.ic_eye_close
                }
              />
            </TouchableOpacity>
          </>
