...
import { colors, fonts, screenWidth } from './src/res/style/theme';
import StatusBarView from './src/components/custom/StatusBarView';
import TextInputAnimated from './src/components/custom/TextInputAnimated';
import AsyncStorage from '@react-native-async-storage/async-storage';
import LoadingView from './src/components/custom/LoadingView';
import { setting } from './src/config/Constant';
import size from './src/res/style/size';
import DeviceInfo from 'react-native-device-info';
import { API_URL_CONFIG } from './src/config/Config';
