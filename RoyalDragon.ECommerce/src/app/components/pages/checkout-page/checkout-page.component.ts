...
export class CheckoutPageComponent implements OnInit {
    ...
    onSubmit(): void {
        console.log(typeof this.listProductCart,this.listProductCart)
        if(this.listProductCart?.length == 0 || this.listProductCart == undefined) {
            this.notifier.notify('error', 'Đặt hàng thất bại xin kiểm tra lại giỏ hàng');
        }else {
          this._eCommerceService.apiECommerceCreateOrderCustomerPost$Json({
            body: {
