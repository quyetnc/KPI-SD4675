...
import { CreateOrderRespone } from '../models/create-order-respone';
...
export class ECommerceService extends BaseService {
  ...
  /**
   * Path part for operation apiECommerceCreateOrderCustomerPost
   */
  static readonly ApiECommerceCreateOrderCustomerPostPath = '/api/ECommerce/CreateOrderCustomer';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiECommerceCreateOrderCustomerPost$Plain()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiECommerceCreateOrderCustomerPost$Plain$Response(params?: {
    context?: HttpContext
    body?: CreateOrderRespone
  }
): Observable<StrictHttpResponse<BooleanResultCustomModel>> {

    const rb = new RequestBuilder(this.rootUrl, ECommerceService.ApiECommerceCreateOrderCustomerPostPath, 'post');
    if (params) {
   ...
   * To access the full response (for headers, for example), `apiECommerceCreateOrderCustomerPost$Plain$Response()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiECommerceCreateOrderCustomerPost$Plain(params?: {
    context?: HttpContext
    body?: CreateOrderRespone
  }
): Observable<BooleanResultCustomModel> {

    return this.apiECommerceCreateOrderCustomerPost$Plain$Response(params).pipe(
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiECommerceCreateOrderCustomerPost$Json()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiECommerceCreateOrderCustomerPost$Json$Response(params?: {
    context?: HttpContext
    body?: CreateOrderRespone
  }
): Observable<StrictHttpResponse<BooleanResultCustomModel>> {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiECommerceCreateOrderCustomerPost$Json$Response()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiECommerceCreateOrderCustomerPost$Json(params?: {
    context?: HttpContext
    body?: CreateOrderRespone
  }
): Observable<BooleanResultCustomModel> {

    return this.apiECommerceCreateOrderCustomerPost$Json$Response(params).pipe(
      map((r: StrictHttpResponse<BooleanResultCustomModel>) => r.body as BooleanResultCustomModel)
    );
  }
