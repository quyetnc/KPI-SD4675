...
import { CostListResultCustomModel } from '../models/cost-list-result-custom-model';
  ...
  apiCostListCostGet$Plain$Response(params?: {
...
): Observable<StrictHttpResponse<CostListResultCustomModel>> {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<CostListResultCustomModel>;
      })
    );
  }
...
): Observable<CostListResultCustomModel> {

    return this.apiCostListCostGet$Plain$Response(params).pipe(
      map((r: StrictHttpResponse<CostListResultCustomModel>) => r.body as CostListResultCustomModel)
    );
  }
