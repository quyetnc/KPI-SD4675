...
{
    public class BadCustomerRequest : IRequest<ResultCustomModel<bool>>
    {
        public int ProductId { get; set; } = 0;
        public class QueryHandler : IRequestHandler<BadCustomerRequest, ResultCustomModel<bool>>
        {
            ...
            public async Task<ResultCustomModel<bool>> Handle(BadCustomerRequest request, CancellationToken cancellationToken)
            {
