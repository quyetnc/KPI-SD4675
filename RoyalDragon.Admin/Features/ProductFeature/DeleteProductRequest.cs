...
{
    public class DeleteProductRequest : IRequest<ResultCustomModel<bool>>
    {
        public List<int> ListProductId { get; set; }

        public class QueryHandler : IRequestHandler<DeleteProductRequest, ResultCustomModel<bool>>
        {
            ...
            public async Task<ResultCustomModel<bool>> Handle(DeleteProductRequest request, CancellationToken cancellationToken)
            {
