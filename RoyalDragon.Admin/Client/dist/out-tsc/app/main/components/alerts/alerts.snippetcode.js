export const snippetCodeDefault = {
    html: `
  <!-- ngb-alert component -->
...
export const snippetCodeClosableAlerts = {
    html: `
  <!-- ngb-alert component -->
  <div *ngIf="!alertClose">
...
export const snippetCodeExample = {
    html: `
<form>
...
//# sourceMappingURL=alerts.snippetcode.js.map