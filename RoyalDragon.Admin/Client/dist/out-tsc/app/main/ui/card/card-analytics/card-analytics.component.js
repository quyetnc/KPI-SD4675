...
let CardAnalyticsComponent = class CardAnalyticsComponent {
    /**
     * Constructor
     *
...
__decorate([
    ViewChild('supportChartoptionsRef')
], CardAnalyticsComponent.prototype, "supportChartoptionsRef", void 0);
__decorate([
    ViewChild('avgsessionChartoptionsRef')
], CardAnalyticsComponent.prototype, "avgsessionChartoptionsRef", void 0);
__decorate([
    ViewChild('revenueReportChartoptionsRef')
], CardAnalyticsComponent.prototype, "revenueReportChartoptionsRef", void 0);
__decorate([
    ViewChild('budgetChartoptionsRef')
], CardAnalyticsComponent.prototype, "budgetChartoptionsRef", void 0);
__decorate([
    ViewChild('goalChartoptionsRef')
], CardAnalyticsComponent.prototype, "goalChartoptionsRef", void 0);
__decorate([
    ViewChild('revenueChartoptionsRef')
], CardAnalyticsComponent.prototype, "revenueChartoptionsRef", void 0);
__decorate([
    ViewChild('salesChartoptionsRef')
], CardAnalyticsComponent.prototype, "salesChartoptionsRef", void 0);
__decorate([
    ViewChild('salesavgChartoptionsRef')
], CardAnalyticsComponent.prototype, "salesavgChartoptionsRef", void 0);
__decorate([
    ViewChild('sessionChartoptionsRef')
], CardAnalyticsComponent.prototype, "sessionChartoptionsRef", void 0);
__decorate([
    ViewChild('customerChartoptionsRef')
], CardAnalyticsComponent.prototype, "customerChartoptionsRef", void 0);
__decorate([
    ViewChild('orderChartoptionsRef')
], CardAnalyticsComponent.prototype, "orderChartoptionsRef", void 0);
__decorate([
    ViewChild('earningChartoptionsRef')
], CardAnalyticsComponent.prototype, "earningChartoptionsRef", void 0);
CardAnalyticsComponent = __decorate([
    Component({
...
export { CardAnalyticsComponent };
//# sourceMappingURL=card-analytics.component.js.map