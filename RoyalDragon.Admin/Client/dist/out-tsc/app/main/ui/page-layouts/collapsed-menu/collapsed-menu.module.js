...
let CollapsedMenuModule = class CollapsedMenuModule {
};
CollapsedMenuModule = __decorate([
    NgModule({
...
export { CollapsedMenuModule };
//# sourceMappingURL=collapsed-menu.module.js.map