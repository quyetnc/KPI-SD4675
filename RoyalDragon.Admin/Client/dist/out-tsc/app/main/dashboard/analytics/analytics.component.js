...
let AnalyticsComponent = class AnalyticsComponent {
     ...
     *
     */
    constructor(_userService, _dashboardService, _coreConfigService) {
...
__decorate([
    ViewChild('gainedChartRef')
], AnalyticsComponent.prototype, "gainedChartRef", void 0);
__decorate([
    ViewChild('orderChartRef')
], AnalyticsComponent.prototype, "orderChartRef", void 0);
__decorate([
    ViewChild('avgSessionChartRef')
], AnalyticsComponent.prototype, "avgSessionChartRef", void 0);
__decorate([
    ViewChild('supportChartRef')
], AnalyticsComponent.prototype, "supportChartRef", void 0);
__decorate([
    ViewChild('salesChartRef')
], AnalyticsComponent.prototype, "salesChartRef", void 0);
