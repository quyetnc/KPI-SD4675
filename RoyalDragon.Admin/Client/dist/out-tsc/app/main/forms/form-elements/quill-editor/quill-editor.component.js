...
let QuillEditorComponent = class QuillEditorComponent {
    constructor() {
        ...
        this._snippetCodeSnowEditor = snippet.snippetCodeSnowEditor;
        this._snippetCodeBubbleEditor = snippet.snippetCodeBubbleEditor;
        this._snippetCodeFullEditor = snippet.snippetCodeFullEditor;
        this._quillEditorContent = snippet.quillEditorContent;
        this.snowEditorRef = `
