export const snippetCodeBasicDP = {
    html: `
  <!-- Basic Date Picker -->
...
export const snippetCodeDisabledDP = {
    html: `
...
export const snippetCodeMinMaxDP = {
    html: `
  <!-- Min-Max Date Picker -->
  <form class="form-inline">
    <div class="form-group">
...
export const snippetCodeCustomFooterDP = {
    html: `
...
export const snippetCodeI18n = {
    html: `
  <date-picker-i18n></date-picker-i18n>
  `
};
export const snippetCodeCustomDay = {
    html: `
...
export const snippetCodeRangeSelectionDP = {
    html: `
...
export const snippetCodeBasicTP = {
    html: `
  <!-- Basic Time Picker -->
...
export const snippetCodeMeridianTP = {
    html: `
...
export const snippetCodeCustomTP = {
    html: `
  <!-- Custom Time Picker -->
...
export const snippetCodeSpinnerTP = {
    html: `
  <!-- Spinner Time Picker -->
...
export const snippetCodeCustomValidationTP = {
    html: `
...
export const snippetCodei18nTP = {
    html: `
  <!-- i18n Time Picker -->
...
//# sourceMappingURL=date-time-picker.snippetcode.js.map