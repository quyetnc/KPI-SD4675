...
let ToastrComponent = class ToastrComponent {
    ...
    constructor(toastr) {
        ...
        this._snippetCodeTopPositions = snippet.snippetCodeTopPositions;
        this._snippetCodeBottomPositions = snippet.snippetCodeBottomPositions;
        this._snippetCodeOptions = snippet.snippetCodeOptions;
        this._snippetCodeRemove = snippet.snippetCodeRemove;
        this._snippetCodeClear = snippet.snippetCodeClear;
        this._snippetCodeEaseTimeout = snippet.snippetCodeEaseTimeout;
        this._snippetCodeCustomToastr = snippet.snippetCodeCustomToastr;
