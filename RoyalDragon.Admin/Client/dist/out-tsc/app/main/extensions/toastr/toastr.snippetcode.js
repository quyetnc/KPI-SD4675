...
export const snippetCodeTopPositions = {
    html: `
  <!-- toastr Top Left -->
...
export const snippetCodeBottomPositions = {
    html: `
  <!-- toastr Bottom Left -->
...
export const snippetCodeOptions = {
    html: `
  <!-- toastr Progress Bar -->
...
export const snippetCodeRemove = {
    html: `
...
export const snippetCodeEaseTimeout = {
    html: `
<!-- toastr EaseTime -->
...
export const snippetCodeCustomToastr = {
    html: `
...
//# sourceMappingURL=toastr.snippetcode.js.map