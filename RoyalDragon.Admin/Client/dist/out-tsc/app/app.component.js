...
import { locale as menuVietNam } from 'app/menu/i18n/vn';
...
let AppComponent = class AppComponent {
    ...
    constructor(document, _title, _renderer, _elementRef, _coreConfigService, _coreSidebarService, _coreLoadingScreenService, _coreMenuService, _coreTranslationService, _translateService) {
        ...
        this._translateService.addLangs(['en', 'fr', 'de', 'pt', 'vn']);
        // This language will be used as a fallback when a translation isn't found in the current language
        this._translateService.setDefaultLang('vn');
        // Set the translations for the menu
        this._coreTranslationService.translate(menuVietNam, menuEnglish, menuFrench, menuGerman, menuPortuguese);
