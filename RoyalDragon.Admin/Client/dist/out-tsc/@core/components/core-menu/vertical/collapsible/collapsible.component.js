...
let CoreMenuVerticalCollapsibleComponent = class CoreMenuVerticalCollapsibleComponent {
    /**
     * Constructor
     *
...
__decorate([
    Input()
], CoreMenuVerticalCollapsibleComponent.prototype, "item", void 0);
__decorate([
    HostBinding('class.open')
], CoreMenuVerticalCollapsibleComponent.prototype, "isOpen", void 0);
CoreMenuVerticalCollapsibleComponent = __decorate([
    Component({
        selector: '[core-menu-vertical-collapsible]',
        templateUrl: './collapsible.component.html'
    })
], CoreMenuVerticalCollapsibleComponent);
export { CoreMenuVerticalCollapsibleComponent };
